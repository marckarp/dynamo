...
| `jobSucceeded` _boolean_ | JobSucceeded is true once the checkpoint Job was observed Complete. It survives Job TTL<br />deletion so Ready still requires observed Job success when the Job is already gone. |  | Optional: \{\} <br /> |
